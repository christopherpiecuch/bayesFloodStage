%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   function bayes_main_code_paper_loocv
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Code written by CGP 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function bayes_main_code_paper_loocv(siteNo)
...
nameOfExperiment='floodstagepaper_loocv';            % experiment name
save_name=[nameOfExperiment,'_siteNo_',num2str(siteNo)];  % file name
...
if siteNo<=numel(lat)&siteNo>0
    lat(siteNo)=[];
    lon(siteNo)=[];
    nws(siteNo)=[];
    nos(siteNo)=[];
    id(siteNo)=[];
else % siteNo>numel(lat)
    error('invalid site number. must be between 1 and 125')
end
nws=log(nws);
